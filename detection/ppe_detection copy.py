...
class PPEDetection:
    ...
    def draw_blue_box(self, frame, track_id, cls_name, confidence, x1, y1, x2, y2, color_type='safe', thickness=1):
        ...
        if color_type == 'violation' or 'Missing' in cls_name:
            ...
            bg_color = (100, 100, 255)  # Light red (BGR format)
        else:
        ...
        cv2.putText(frame, label, (text_x, text_y), font, font_scale, (0, 0, 0), text_thickness + 2, cv2.LINE_AA)
    ...
    def process_ppe_detection(self, frame, polygon=None):
        ...
        results = self.det_model.track(source=frame, persist=True, conf=0.7, iou=0.5, verbose=False)
            ...
            if processed_frame is not None and isinstance(processed_frame, np.ndarray):
                ...
                if ret:
                    ...
                    try:
                        ...
                        time.sleep(get_time_sleep())  # 30 FPS
